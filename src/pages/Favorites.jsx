    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <h2 className="font-display text-2xl font-bold text-coffee-800 mb-2">Tus favoritos</h2>
          <p className="font-body text-coffee-500 mb-6">Iniciá sesión para ver y guardar tus cafeterías favoritas.</p>
    ...
    <div className="min-h-screen bg-cream-100">
      <div className="bg-coffee-700 py-10 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="font-body text-cream-300 mt-1">{favCafes.length} cafeterías guardadas (local)</p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        {favCafes.length === 0 ? (
          <div className="text-center py-20">
            <Heart size={56} className="mx-auto text-coffee-200 mb-4" />
            <h3 className="font-display text-2xl font-semibold text-coffee-600 mb-2">Sin favoritos todavía</h3>
            <p className="font-body text-coffee-400 mb-6">Explorá cafeterías y guardá las que más te gusten.</p>
